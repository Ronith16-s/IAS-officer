        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus</h4>
              <p>
                Building full-stack web applications, designing robust databases, and leveraging developer tools to write clean, maintainable code.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus</h4>
              <p>
                Designing user interfaces, crafting custom prototypes, and creating creative visual content with pixel-perfect layouts.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus</h4>
              <p>
                Performing advanced data analytics, spreadsheet modeling, and coordinating projects with strong soft skills and agile practices.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Self-learning</div>
                <div className="what-tags">Quick Thinking</div>
